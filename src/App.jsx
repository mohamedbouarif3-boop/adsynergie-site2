...
            role="region" // Rôle pour le carrousel
            aria-label="Liste des services"
          >
            {SERVICES.map((s, i) => (
              // Ajout d'attributs A11Y pour chaque slide
              <div
                key={i}
...
                aria-hidden={index !== i} // Cache l'élément s'il n'est pas actif
              >
...
  // Applique la couleur 'brand-teal' au badge et au prix pour la carte highlight
  const badgeColor = p.highlight ? "text-brand-teal" : "text-slate-500";
  const priceColor = p.highlight ? "text-brand-teal" : "text-brand-ink";

  return (
    <div className={`min-w-full p-6 sm:p-8 ${p.highlight ? "bg-white border-2 border-brand-teal shadow-lg" : "bg-white/80 border border-slate-200"} rounded-2xl`}>
...
              <div>
                {/* A11Y: Ajout de htmlFor/id */}
                <label htmlFor="first_name" className="block text-sm font-medium">Prénom</label>
                <input id="first_name" name="first_name" required className="mt-1 w-full rounded-lg border px-3 py-2" placeholder="Votre prénom" />
              </div>
              <div>
                {/* A11Y: Ajout de htmlFor/id */}
                <label htmlFor="last_name" className="block text-sm font-medium">Nom</label>
                <input id="last_name" name="last_name" required className="mt-1 w-full rounded-lg border px-3 py-2" placeholder="Votre nom" />
              </div>
            </div>
...
              <input id="email" type="email" inputMode="email" autoComplete="email" name="email" required className="mt-1 w-full rounded-lg border px-3 py-2" placeholder="vous@email.com" />
            </div>

            <div>
              {/* A11Y: Ajout de htmlFor/id */}
              <label htmlFor="message" className="block text-sm font-medium">Message</label>
              <textarea id="message" name="message" rows="4" className="mt-1 w-full rounded-lg border px-3 py-2" placeholder="Expliquez votre activité et vos objectifs…"></textarea>
            </div>
